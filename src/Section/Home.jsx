...
const socials=[
  {Icon:FaLinkedin,label:'LinkedIn',link:'https://github.com/naveenbanjara89'},
        ...
        <div className='flex flex-col justify-center h-full text-center lg:text-left relative '>
          <div className='w-full lg:pr-24 mx-auto max-w-[48rem] '>
            ...
            transition={{duration:0.8,delay:0.8}} >
              ...
              <a id='resume' href='/NaveenBanjaraResume.pdf'  className='px-6 py-3 rounded-full text-lg font-medium bg-white text-black hover:bg-gray-200 shadow-lg hover:scale-105 transition-all  '>My Resume </a>
            </motion.div>
          </div>
        </div>
      </div>
