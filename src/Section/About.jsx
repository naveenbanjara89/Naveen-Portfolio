  ...
  return (
    <section id='about' className='min-h-screen w-full flex items-center justify-center relative bg-black text-white overflow-hidden ' >
      ...
      <div className='relative z-10 max-w-6xl w-full mx-auto px-6 md:px-10 lg:px-12 py-20 flex flex-col gap-12'>
        ...
        >
          <motion.div className='relative w-[160px] h-[160px] md:w-[200px] md:h-[200px] rounded-2xl overflow-hidden shadow-2xl bg-gradient-to-r from-[#1cd8d2]/20 to-[#302663]/20 border border-[#1cd8d2]/25 cursor-pointer  '
          ...
          <div className='flex-1 flex flex-col justify-center text-center md:text-left '>
            <h2 className='text-4xl sm:text-5xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-[#302b63] via-[#00bf8f] to-[#1cd8d2]  '>
              ...
              <p className='mt-4 text-gray-300 leading-relaxed text-base sm:text-lg max-w-2xl md:max-w-3xl  '>
                I build scalable,modern applications with a strong focus on clean architecture, delightful UI, and performance. My toolkit spans Java, C++, React, Node.JS, Tailwind CSS and API's-bringing ideas to life from concepts to production with smooth interfaces.
              </p>

              <div className='grid grid-cols-2 sm:grid-cols-3 sm:gap-4 max-w-xl  gap-3 mt-6'>
                {stats.map((item,i)=>(
              ...
              <div className='flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center md:justify-start mt-7'>
                <a href='#projects' className='inline-flex items-center  justify-center rounded-lg bg-gray-200 text-black font-semibold px-5 py-3 hover:bg-gray-500 transition '>View Project</a>
        ...
        transition={{duration:0.6}}
          ...
          <p className='text-gray-300 leading-relaxed text-base sm:text-lg'>
            I'm a Software Developer and Web Developer - passionate about building fast , resilient apllication.Eager to learn, grow, and contribute to a supportive development team.

          </p>
          <p className='mt-4 text-gray-400 taxt-base sm:text-lg '>
